...
I'm going to call #2 a farce and this is _totally based on my experience._ I've had many sponsors (recruiters) say "We'll send the word out to our people and see if we can get out to the group." But the people don't come.

So that leaves #1. Food. Drinks. Substance of some kind.

**How does this empower you?**  
THEY need you more than YOU need them. Let's look at a worse case scenario: _you have no sponsors for food_.
...
Take that last paragraph with a grain of salt. It's a real _first world problem_. Smaller groups might not want to pull that card, and that's okay. But don't bend over backwards for sponsors.
