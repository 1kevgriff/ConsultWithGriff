...
import crazy_fast_002 from '../../assets/blog/local/crazy-fast-002.png';
import crazy_fast_001 from '../../assets/blog/local/crazy-fast-001.png';
...
<Image src={crazy_fast_002} alt="Azure Blob Storage with CloudFlare" quality={80} format="webp" loading="lazy" widths={[400, 800, 1200]} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 80vw, 1200px" />

**Azure Static Web Apps**  
<Image src={crazy_fast_001} alt="Azure Blob Storage with CloudFlare" quality={80} format="webp" loading="lazy" widths={[400, 800, 1200]} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 80vw, 1200px" />
