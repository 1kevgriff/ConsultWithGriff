...
import twitchlib from '../../assets/blog/local/twitchlib.png';
...
<Image src={twitchlib} alt="TwitchLib" quality={80} format="webp" loading="lazy" widths={[400, 800, 1200]} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 80vw, 1200px" />
