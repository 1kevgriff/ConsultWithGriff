...
import _2021_12_08_upgrade_assistant_sample from '../../assets/blog/local/2021-12-08-upgrade-assistant-sample.png';
...
<Image src={_2021_12_08_upgrade_assistant_sample} alt="Upgrade Assistant" quality={80} format="webp" loading="lazy" widths={[400, 800, 1200]} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 80vw, 1200px" />
