...
import whatisdapper_data_to_objects from '../../assets/blog/local/whatisdapper_data_to_objects.png';
...
<Image src={whatisdapper_data_to_objects} alt="SQL Result + Object" quality={80} format="webp" loading="lazy" widths={[400, 800, 1200]} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 80vw, 1200px" />
