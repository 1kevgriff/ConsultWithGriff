...
During one of my latest renditions of Better Object Relational Mapping with Dapper (check out my guide on [What is Dapper](/blog/what-is-dapper)), the question arose about using stored procedures.
...
For more on database configuration, see my article on [building better connection strings](/blog/building-better-connectionstrings-with-connectionstringbuilder).
