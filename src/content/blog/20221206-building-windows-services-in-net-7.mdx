...
import windowservices_watchfolder from '../../assets/blog/local/windowservices-watchfolder.png';
import windowservices_serviceview from '../../assets/blog/local/windowservices-serviceview.png';
import windowservices_inaction from '../../assets/blog/local/windowservices-inaction.gif';
...
<Image src={windowservices_watchfolder} alt="Watch Folder" quality={80} format="webp" loading="lazy" widths={[400, 800, 1200]} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 80vw, 1200px" />
...
<Image src={windowservices_serviceview} alt="Windows Services" quality={80} format="webp" loading="lazy" widths={[400, 800, 1200]} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 80vw, 1200px" />
...
<Image src={windowservices_inaction} alt="In Action" quality={80} format="webp" loading="lazy" widths={[400, 800, 1200]} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 80vw, 1200px" />
