...
import signalr_mastery_thumbnail from '../../assets/blog/local/signalr-mastery-thumbnail.png';



[<Image src={signalr_mastery_thumbnail} alt="SignalR Mastery" quality={80} format="webp" loading="lazy" widths={[400, 800, 1200]} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 80vw, 1200px" />](https://www.udemy.com/course/signalr-mastery/learn/?referralCode=5F129296A976F8353B79)
