...
import _20241031_azure_functions_host_error from '../../assets/blog/local/20241031-azure-functions-host-error.jpg';
...
<Image src={_20241031_azure_functions_host_error} alt="No bindings found in function" quality={80} format="webp" loading="lazy" widths={[400, 800, 1200]} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 80vw, 1200px" />
