...
Turns out, the awesome team behind Azure Static Web Apps thought about this and built a mechanism for doing server-side redirects. If you're not familiar with Azure Static Web Apps, check out my article on [why I love Azure Static Web Apps](/i-love-azure-static-web-apps) first.
