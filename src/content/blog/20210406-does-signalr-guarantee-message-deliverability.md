...
This is a commonly asked question from folks in the community (and students in my [SignalR Mastery](/signal-mastery-launched) course), and this is going to be a difficult pill for some folks to swallow:
