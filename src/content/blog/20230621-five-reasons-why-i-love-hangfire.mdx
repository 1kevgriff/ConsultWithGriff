...
import _2023_06_19_hangfire_dashboard from '../../assets/blog/local/2023-06-19-hangfire-dashboard.png';
import _2023_06_19_hangfire_recurring from '../../assets/blog/local/2023-06-19-hangfire-recurring.png';
import _2023_06_19_hangfire_failures from '../../assets/blog/local/2023-06-19-hangfire-failures.png';
import _2023_06_19_hangfire_retry from '../../assets/blog/local/2023-06-19-hangfire-retry.png';
import hangfire_udemy from '../../assets/blog/local/hangfire-udemy.png';
...
<Image src={_2023_06_19_hangfire_dashboard} alt="HangFire Dashboard" quality={80} format="webp" loading="lazy" widths={[400, 800, 1200]} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 80vw, 1200px" />
...
<Image src={_2023_06_19_hangfire_recurring} alt="HangFire Recurring" quality={80} format="webp" loading="lazy" widths={[400, 800, 1200]} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 80vw, 1200px" />
...
<Image src={_2023_06_19_hangfire_failures} alt="HangFire Failures" quality={80} format="webp" loading="lazy" widths={[400, 800, 1200]} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 80vw, 1200px" />
...
<Image src={_2023_06_19_hangfire_retry} alt="HangFire Retries" quality={80} format="webp" loading="lazy" widths={[400, 800, 1200]} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 80vw, 1200px" />
...
[<Image src={hangfire_udemy} alt="Building Background Services in .NET with HangFire" quality={80} format="webp" loading="lazy" widths={[400, 800, 1200]} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 80vw, 1200px" />](https://www.udemy.com/course/building-background-services-in-net-with-hangfire/?referralCode=ADE705B8BB4A44749A7D)
