...
import azure_static_app_routing_001 from '../../assets/blog/local/azure-static-app-routing-001.png';
...
<Image src={azure_static_app_routing_001} alt="Sample request" quality={80} format="webp" loading="lazy" widths={[400, 800, 1200]} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 80vw, 1200px" />
