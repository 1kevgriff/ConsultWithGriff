...
import Shoutout from "../../components/Shoutout.astro";

<Shoutout>This article is my entry to C# Advent 2022 and .NET Advent. Please visit [C# Advent](https://www.csadvent.christmas/) and [.NET Advent](https://dotnet.christmas) to see all the other great articles!</Shoutout>
